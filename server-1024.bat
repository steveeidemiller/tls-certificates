...
openssl x509 -req -in server-1024.csr -CA ca-1024.crt -CAkey ca-1024.key -CAcreateserial -out server-1024.crt -days 3650 -sha256 -extensions v3_req -extfile server-1024.cnf
