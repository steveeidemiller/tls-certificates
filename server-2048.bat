...
openssl x509 -req -in server-2048.csr -CA ca-2048.crt -CAkey ca-2048.key -CAcreateserial -out server-2048.crt -days 3650 -sha256 -extensions v3_req -extfile server-2048.cnf
